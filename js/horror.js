...
const settings = {
	"async": true,
	"crossDomain": true,
	"url": "https://imdb8.p.rapidapi.com/auto-complete?q=the%20exorcist",
	"method": "GET",
	"headers": {
...
const settings2 = {
	"async": true,
	"crossDomain": true,
	"url": "https://imdb8.p.rapidapi.com/auto-complete?q=carrie",
	"method": "GET",
	"headers": {
		"x-rapidapi-key": "93f8468805msh8eb0d7c18ccdb0ep138158jsn89b55ce8261e",
		"x-rapidapi-host": "imdb8.p.rapidapi.com"
...
$.ajax(settings2).done(function (response) {
	console.log(response.d[3]);
	$("#movie_info_2").append("<img src=" + response.d[3].i.imageUrl + " height='250px' width='175px'>");
	$("#movie_info_2").append("<br>" + response.d[3].l + "</br>");
	$("#movie-two").append("<div>Year: " + response.d[3].y + "</div>");
	$("#movie-two").append("<div>Rank on IMDb: " + response.d[3].rank);
	$("#movie-two").append("<div>Starring: " + response.d[3].s);
});
...
const settings3 = {
	"async": true,
	"crossDomain": true,
	"url": "https://imdb8.p.rapidapi.com/auto-complete?q=the%20platform",
	"method": "GET",
	"headers": {
		"x-rapidapi-key": "93f8468805msh8eb0d7c18ccdb0ep138158jsn89b55ce8261e",
		"x-rapidapi-host": "imdb8.p.rapidapi.com"
